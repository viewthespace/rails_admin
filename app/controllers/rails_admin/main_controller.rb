module RailsAdmin
  ...
  class MainController < RailsAdmin::ApplicationController
    ...
    def get_collection(model_config, scope, pagination)
      associations = model_config.list.fields.select {|f| (f.type == :belongs_to_association || f.type == :has_one_association || f.type == :has_many_association) && !f.polymorphic? }.map {|f| f.association[:name] }
      options = {}
